...
public class TestBMICalculatorIT {
    ...
    public void testCaclulate3() {
        ...
        // Make a HTTP GET request to retrieve the last created Parolee.
        try (Response response = client.target(WEB_URI+"?weight=41&height=1.65").request().get()) {
    ...
    public void testCaclulate4() {
        ...
        // Make a HTTP GET request to retrieve the last created Parolee.
        try (Response response = client.target(WEB_URI+"?weight=75&height=1.4").request().get()) {
